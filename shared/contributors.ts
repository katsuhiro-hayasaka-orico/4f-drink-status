...
export const CONTRIBUTOR_TIERS: readonly ContributorTier[] = [
  ...
  { key: 'expert', label: '達人', at: 50, stars: 2 },
  { key: 'master', label: '名人', at: 100, stars: 3 },
];
...
/** 「「達人」まであと27件」 — or nothing, at the top of the ladder. */
...
/** 「常連10件・達人50件・名人100件」 — the ladder, spelled out for a footnote. */
