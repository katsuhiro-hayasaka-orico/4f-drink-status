...
const FROM_FEEDBACK: ShippedItem[] = [
  ...
  {
    when: '2026-09-18',
    voice: '「十分にある」「残り少なめ」がどのくらいの分量なのか分かりにくい。割合で選べるようにしてほしい',
    change:
      '見かけた残量を「たっぷり（9割以上）／半分くらい（5〜7割）／少なめ（3割ほど）／ほとんどない（1割以下）」の4段階で報告できるようにし（タップ数は変わりません）、「材料の推定残量」はみんなの報告を平均した値を表示するようにしました',
  },
];
